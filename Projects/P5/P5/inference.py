...
class DiscreteDistribution(dict):
    ...
    def sample(self):
        ...
        for item in self.items():
            seq.append(item[0])
            weights.append(item[1] / self.total())
...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for ghostPos in self.allPositions:
            self.beliefs[ghostPos] *= self.getObservationProb(observation, gameState.getPacmanPosition(),
...
class ParticleFilter(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for particle in self.particles:
            dist[particle] += self.getObservationProb(observation, gameState.getPacmanPosition(),
